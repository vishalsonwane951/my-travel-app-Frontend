  ...
  useEffect(() => {
    const fetchAllPackagesData = async () => {
      ...
      try {
        ...
        const response = await api.get('/explore-packages/goa/getallpackage');
    ...
    <div className="goa-package">
      ...
      <div className="hero-section text-center text-white position-relative">
        ...
        <div className="container position-relative z-index-1 py-5">
          <h1 className="display-3 fw-bold mb-3">Goa Golden Escape</h1>
          ...
          <div className="pricing-card p-5 rounded-4 shadow-lg">
            <div className="row align-items-center">
              <div className="col-lg-7">
                <h2 className="display-5 fw-bold mb-3">Ready to Experience Goa?</h2>
      ...
      <div className="container-fluid final-cta py-5 mb-0">
        <div className="container text-center">
          <h2 className="display-5 fw-bold text-white mb-4">Your Goa Adventure Awaits</h2>
...
[
  {
    ...
    "duration": "3D/2N",
    "highlights": [
      { "icon": "🏖️", "text": "Baga Beach Relaxation" },
      { "icon": "🏰", "text": "Visit Fort Aguada" },
      { "icon": "🌅", "text": "Sunset at Chapora Fort" },
      { "icon": "🍤", "text": "Seafood Dining Experience" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival & Beach Time",
        "activities": [
          "12:00 PM - Arrival in Goa",
          "03:00 PM - Relax at Baga Beach",
          "06:00 PM - Sunset at Chapora Fort"
        ],
        "icon": "🏖️"
      },
      {
        "day": "Day 2: Heritage & Market Visit",
        "activities": [
          "09:00 AM - Visit Fort Aguada",
          "12:00 PM - Explore Old Goa Churches",
          "04:00 PM - Shop at Anjuna Flea Market"
        ],
        "icon": "🏰"
      },
      {
    ...
    "gallery": [
      { "img": "https://i.pinimg.com/1200x/97/9a/af/979aafee1b03f1981f72b458795ff013.jpg", "caption": "Baga Beach" },
      { "img": "https://i.pinimg.com/1200x/90/0d/45/900d4505f8c2c4b50c485dd6d1912adf.jpg", "caption": "Fort Aguada" },
      { "img": "https://i.pinimg.com/1200x/3e/a4/05/3ea405ce9e129648d7df57d456ed281d.jpg", "caption": "Chapora Fort" },
      { "img": "https://i.pinimg.com/1200x/07/d6/cc/07d6cca37e778d08e23d0c7be1a306b2.jpg", "caption": "Seafood Dining" }
    ],
    "testimonials": [
      {
        "quote": "Perfect quick getaway with sun, sea, and history.",
        "author": "Aisha & Sameer",
        "rating": 5,
        "avatar": "👫"
      }
  ...
  },
  {
    ...
    "duration": "4D/3N",
    "highlights": [
      { "icon": "🏖️", "text": "Beaches of Baga & Calangute" },
      { "icon": "🏰", "text": "Fort Aguada & Old Goa Churches" },
      { "icon": "🌊", "text": "Water Sports Activities" },
      { "icon": "🛍️", "text": "Anjuna Flea Market Shopping" },
      { "icon": "🍹", "text": "Beachside Nightlife" }
    ],
    "itinerary": [
      {
        ...
        "activities": [
          "12:00 PM - Arrival in Goa",
          "03:00 PM - Relax at Calangute Beach"
        ],
        "icon": "🏖️"
      },
      {
        "day": "Day 2: Heritage & Water Sports",
        "activities": [
          "09:00 AM - Visit Fort Aguada",
          "12:00 PM - Explore Old Goa Churches",
          "03:00 PM - Water sports at Baga Beach"
        ],
        "icon": "🏰"
      },
      {
        "day": "Day 3: Market & Nightlife",
        "activities": [
          "10:00 AM - Shop at Anjuna Flea Market",
          "07:00 PM - Enjoy beachside nightlife at Tito’s"
        ],
        "icon": "🛍️"
      },
      {
    ...
    "gallery": [
      { "img": "https://i.pinimg.com/1200x/41/88/46/41884604312499b0fc1c3314ad49858a.jpg", "caption": "Calangute Beach" },
      { "img": "https://i.pinimg.com/1200x/bd/3e/36/bd3e36eb07b7d0b0a53d77c3df7f9913.jpg", "caption": "Water Sports" },
      { "img": "https://i.pinimg.com/1200x/b1/ab/c7/b1abc71645925d5515265d374aa2a371.jpg", "caption": "Anjuna Flea Market" },
      { "img": "https://i.pinimg.com/1200x/62/67/c0/6267c0c5327e10560bcb60d1487a34cf.jpg", "caption": "Tito’s Nightclub" }
    ],
    "testimonials": [
      {
        "quote": "A perfect blend of beach fun, culture, and nightlife.",
        "author": "Rahul & Neha",
        "rating": 5,
        "avatar": "👩‍❤️‍👨"
      }
  ...
  },
  {
    ...
    "duration": "5D/4N",
    "highlights": [
      { "icon": "🏖️", "text": "Explore Beaches of Baga, Calangute & Palolem" },
      { "icon": "🏰", "text": "Visit Fort Aguada & Cabo De Rama Fort" },
      { "icon": "🌊", "text": "Water Sports & Dolphin Watching" },
      { "icon": "🛍️", "text": "Shop at Flea Markets & Local Bazaars" },
      { "icon": "🍽️", "text": "Authentic Goan Cuisine" },
      { "icon": "🎉", "text": "Vibrant Nightlife & Beach Parties" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival & Beach Relaxation",
        "activities": [
          "12:00 PM - Arrival in Goa",
          "03:00 PM - Relax at Palolem Beach"
        ],
        "icon": "🏖️"
      },
      {
        "day": "Day 2: Heritage & Water Activities",
        "activities": [
          "09:00 AM - Visit Fort Aguada and Cabo De Rama Fort",
          "01:00 PM - Dolphin watching tour",
          "05:00 PM - Water sports at Calangute Beach"
        ],
        "icon": "🏰"
      },
      {
        "day": "Day 3: Market & Cuisine",
        "activities": [
          "10:00 AM - Shop at Anjuna and Mapusa Markets",
          "07:00 PM - Try authentic Goan seafood at local restaurants"
        ],
        "icon": "🛍️"
      },
      {
        "day": "Day 4: Beach & Leisure",
        "activities": [
          "09:00 AM - Relax at Baga Beach",
          "05:00 PM - Evening beach party"
        ],
        "icon": "🎉"
      },
      {
    ...
    "gallery": [
      { "img": "https://i.pinimg.com/1200x/69/d5/98/69d598583f2d5f192f978b49c2dc1d30.jpg", "caption": "Palolem Beach" },
      { "img": "https://i.pinimg.com/1200x/91/c8/be/91c8be268df1058e6d634ea1589eca24.jpg", "caption": "Cabo De Rama Fort" },
      { "img": "https://i.pinimg.com/1200x/ee/cd/a0/eecda0ebc2ad5828130b72c38f8129dd.jpg", "caption": "Dolphin Watching" },
      { "img": "https://i.pinimg.com/1200x/3f/0b/8b/3f0b8b590f8b59dd1ae2a377b4f2c801.jpg", "caption": "Beach Party" },
    ],
    "testimonials": [
      {
        "quote": "Five days of sun, sea, and Goan hospitality!",
        "author": "Sunil & Riya",
        "rating": 5,
        "avatar": "👫"
      }
  ...
  },
  {
    ...
    "duration": "7D/6N",
    "highlights": [
      { "icon": "🏖️", "text": "Explore Multiple Beaches: Baga, Calangute, Palolem & Vagator" },
      { "icon": "🏰", "text": "Visit Historical Forts & Churches" },
      { "icon": "🌊", "text": "Water Sports & Dolphin Tours" },
      { "icon": "🛍️", "text": "Shopping at Flea Markets & Local Bazaars" },
      { "icon": "🍽️", "text": "Authentic Goan Cuisine & Nightlife" },
      { "icon": "🎉", "text": "Attend Beach Parties & Cultural Events" },
      { "icon": "🚤", "text": "Island Hopping & Boat Cruises" }
    ],
    "itinerary": [
      {
      ...
      {
        "day": "Day 2: Heritage Tour",
        "activities": [
          "09:00 AM - Visit Fort Aguada and Old Goa Churches",
          "02:00 PM - Explore Panaji city"
        ],
        "icon": "🏰"
      },
      {
        "day": "Day 3: Beaches & Water Sports",
        "activities": [
          "10:00 AM - Water sports at Calangute Beach",
          "04:00 PM - Sunset at Vagator Beach"
        ],
        "icon": "🌊"
      },
      {
        "day": "Day 4: Market & Cuisine",
        "activities": [
          "10:00 AM - Shop at Anjuna Flea Market",
          "07:00 PM - Try Goan seafood delicacies"
        ],
        "icon": "🛍️"
      },
      {
        "day": "Day 5: Island Hopping",
        "activities": [
          "08:00 AM - Boat cruise and island hopping",
          "04:00 PM - Relax at beach"
        ],
        "icon": "🚤"
      },
      {
        "day": "Day 6: Leisure & Nightlife",
        "activities": [
          "Day at leisure",
          "Evening beach party or cultural event"
        ],
        "icon": "🎉"
      },
      {
    ...
    "gallery": [
      { "img": "https://i.pinimg.com/1200x/db/7a/bf/db7abfb817516b97d929644c3bad3d27.jpg", "caption": "Vagator Beach" },
      { "img": "https://i.pinimg.com/1200x/34/ff/e6/34ffe6489af2e546022a8839a2f0e81e.jpg", "caption": "Old Goa Churches" },
      { "img": "https://i.pinimg.com/1200x/fe/2d/fd/fe2dfd7d55cf9e8361afae0d9a8164f6.jpg", "caption": "Island Hopping" },
      { "img": "https://i.pinimg.com/1200x/3f/0b/8b/3f0b8b590f8b59dd1ae2a377b4f2c801.jpg", "caption": "Beach Party" },
      { "img": "https://i.pinimg.com/1200x/b6/a5/a5/b6a5a5c70cea69a588d727c0ee002003.jpg", "caption": "Anjuna Flea Market" }
    ],
    "testimonials": [
      {
        "quote": "A full week of sun, culture, and unforgettable memories in Goa.",
        "author": "Anita & Vikram",
        "rating": 5,
        "avatar": "👨‍👩‍👧‍👦"
      }
