  ...
  useEffect(() => {
    const fetchAllPackagesData = async () => {
      ...
      try {
        ...
        const response = await api.get('/explore-packages/kashmir/getallpackage');
    ...
    <div className="goa-package">
      ...
      <div className="hero-section text-center text-white position-relative">
        ...
        <div className="container position-relative z-index-1 py-5">
          <h1 className="display-3 fw-bold mb-3">Kashmir  Golden Escape</h1>
          ...
          <div className="pricing-card p-5 rounded-4 shadow-lg">
            <div className="row align-items-center">
              <div className="col-lg-7">
                <h2 className="display-5 fw-bold mb-3">Ready to Experience Kashmir?</h2>
      ...
      <div className="container-fluid final-cta py-5 mb-0">
        <div className="container text-center">
          <h2 className="display-5 fw-bold text-white mb-4">Your Kashmir Adventure Awaits</h2>
...
[
  {
    ...
    "duration": "3D/2N",
    "highlights": [
      { "icon": "🏞️", "text": "Dal Lake Shikara Ride" },
      { "icon": "🌸", "text": "Mughal Gardens Visit" },
      { "icon": "🕌", "text": "Shankaracharya Temple" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival & Srinagar City Tour",
        "activities": [
          "12:00 PM - Arrival at Srinagar",
          "02:00 PM - Shikara Ride on Dal Lake",
          "05:00 PM - Visit Mughal Gardens"
        ],
        "icon": "🏙️"
      },
      {
        ...
        "activities": [
          "07:00 AM - Breakfast",
          "09:00 AM - Drive to Gulmarg",
          "01:00 PM - Gondola Ride and local sightseeing",
          "05:00 PM - Return to Srinagar"
        ],
        "icon": "⛰️"
      },
      {
        "day": "Day 3: Local Sightseeing & Departure",
        "activities": [
          "08:00 AM - Visit Shankaracharya Temple",
    ...
    "gallery": [
      { "img": "https://via.placeholder.com/1200x800?text=Dal+Lake+Shikara", "caption": "Shikara Ride on Dal Lake" },
      { "img": "https://via.placeholder.com/1200x800?text=Mughal+Gardens", "caption": "Mughal Gardens" },
      { "img": "https://via.placeholder.com/1200x800?text=Gulmarg+Gondola", "caption": "Gondola Ride in Gulmarg" },
      { "img": "https://via.placeholder.com/1200x800?text=Shankaracharya+Temple", "caption": "Shankaracharya Temple" },
      { "img": "https://via.placeholder.com/1200x800?text=Srinagar+Cityscape", "caption": "Srinagar City View" },
      { "img": "https://via.placeholder.com/1200x800?text=Kashmir+Mountains", "caption": "Kashmir Mountains" }
    ],
    "testimonials": [
      {
        "quote": "Mesmerizing views and peaceful vibes all around Kashmir!",
  ...
  },
  {
    ...
    "duration": "4D/3N",
    "highlights": [
      { "icon": "🏞️", "text": "Pahalgam Valley" },
      { "icon": "🛶", "text": "Dal Lake Houseboat Stay" },
      { "icon": "🏔️", "text": "Betaab Valley Visit" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival in Srinagar & Houseboat Stay",
        "activities": [
          "12:00 PM - Arrive in Srinagar",
          "02:00 PM - Check-in to Houseboat on Dal Lake",
          "06:00 PM - Relax and enjoy sunset"
        ],
        "icon": "🚤"
      },
      {
        "day": "Day 2: Srinagar to Pahalgam",
        "activities": [
          "08:00 AM - Breakfast",
          "10:00 AM - Drive to Pahalgam",
          "03:00 PM - Visit Betaab Valley and local sightseeing"
        ],
        "icon": "🏞️"
      },
      {
        "day": "Day 3: Pahalgam Adventure & Local Tours",
        "activities": [
          "07:00 AM - Breakfast",
          "09:00 AM - Horse riding and river rafting",
          "05:00 PM - Return to Srinagar"
        ],
        "icon": "🏇"
      },
      {
        "day": "Day 4: Srinagar Local Sightseeing & Departure",
        "activities": [
          "08:00 AM - Visit Shankaracharya Temple and local markets",
          "12:00 PM - Checkout and transfer"
        ],
        "icon": "✈️"
      }
    ],
    "gallery": [
      { "img": "https://via.placeholder.com/1200x800?text=Houseboat+Dal+Lake", "caption": "Houseboat Stay on Dal Lake" },
      { "img": "https://via.placeholder.com/1200x800?text=Pahalgam+Valley", "caption": "Pahalgam Valley" },
      { "img": "https://via.placeholder.com/1200x800?text=Betaab+Valley", "caption": "Betaab Valley" },
      { "img": "https://via.placeholder.com/1200x800?text=Horse+Riding+Pahalgam", "caption": "Horse Riding" },
      { "img": "https://via.placeholder.com/1200x800?text=Srinagar+Markets", "caption": "Local Markets in Srinagar" },
      { "img": "https://via.placeholder.com/1200x800?text=Kashmir+Scenic", "caption": "Scenic Kashmir" }
    ],
    "testimonials": [
      {
        "quote": "The houseboat experience and Pahalgam adventure were unforgettable!",
        "author": "Rina & Arjun",
        "rating": 5,
        "avatar": "👩‍❤️‍👨"
      }
  ...
  },
  {
    ...
    "duration": "5D/4N",
    "highlights": [
      { "icon": "❄️", "text": "Gulmarg Skiing & Gondola" },
      { "icon": "🌊", "text": "Dal Lake & Floating Market" },
      { "icon": "🌳", "text": "Sonamarg Day Trip" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival in Srinagar",
        "activities": [
          "12:00 PM - Arrive at Srinagar",
          "02:00 PM - Dal Lake Shikara Ride"
        ],
        "icon": "🚤"
      },
      {
        ...
        "activities": [
          "07:00 AM - Breakfast",
          "09:00 AM - Drive to Gulmarg",
          "12:00 PM - Gondola ride and skiing",
          "05:00 PM - Return to Srinagar"
        ],
        "icon": "⛷️"
      },
      {
        "day": "Day 3: Sonamarg Day Trip",
        "activities": [
          "08:00 AM - Depart for Sonamarg",
          "10:00 AM - Explore Thajiwas Glacier",
          "04:00 PM - Return to Srinagar"
        ],
        "icon": "🏞️"
      },
      {
        "day": "Day 4: Srinagar Local Sightseeing",
        "activities": [
          "09:00 AM - Visit Mughal Gardens and Shankaracharya Temple",
          "04:00 PM - Floating Market visit"
        ],
        "icon": "🌸"
      },
      {
        ...
        "activities": [
          "08:00 AM - Breakfast",
          "11:00 AM - Checkout and transfer"
        ],
        "icon": "✈️"
      }
    ],
    "gallery": [
      { "img": "https://via.placeholder.com/1200x800?text=Gulmarg+Gondola", "caption": "Gulmarg Gondola Ride" },
      { "img": "https://via.placeholder.com/1200x800?text=Dal+Lake+Floating+Market", "caption": "Dal Lake Floating Market" },
      { "img": "https://via.placeholder.com/1200x800?text=Sonamarg+Thajiwas+Glacier", "caption": "Thajiwas Glacier, Sonamarg" },
      { "img": "https://via.placeholder.com/1200x800?text=Mughal+Gardens", "caption": "Mughal Gardens" },
      { "img": "https://via.placeholder.com/1200x800?text=Shankaracharya+Temple", "caption": "Shankaracharya Temple" },
      { "img": "https://via.placeholder.com/1200x800?text=Kashmir+Winter+Scenery", "caption": "Winter Scenery in Kashmir" }
    ],
    "testimonials": [
      {
        "quote": "The perfect mix of adventure and serene beauty in Kashmir!",
        "author": "Zara & Sameer",
        "rating": 5,
        "avatar": "👩‍❤️‍👨"
      }
  ...
  },
  {
    ...
    "duration": "7D/6N",
    "highlights": [
      { "icon": "🏔️", "text": "Comprehensive Kashmir Tour" },
      { "icon": "🚤", "text": "Houseboat & Shikara Rides" },
      { "icon": "❄️", "text": "Gulmarg Skiing & Snow Activities" },
      { "icon": "🏞️", "text": "Pahalgam & Sonamarg Exploration" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival in Srinagar",
        "activities": [
          ...
          "03:00 PM - Shikara ride on Dal Lake"
        ],
        "icon": "🚤"
      },
      {
        "day": "Day 2: Srinagar Local Sightseeing",
        "activities": [
          "09:00 AM - Visit Mughal Gardens and Shankaracharya Temple",
          "05:00 PM - Explore local markets"
        ],
        "icon": "🏙️"
      },
      {
        "day": "Day 3: Gulmarg Adventure",
        "activities": [
          "07:00 AM - Drive to Gulmarg",
          "10:00 AM - Gondola ride and skiing",
          "06:00 PM - Return to Srinagar"
        ],
        "icon": "⛷️"
      },
      {
        "day": "Day 4: Pahalgam Excursion",
        "activities": [
          "08:00 AM - Travel to Pahalgam",
          "01:00 PM - Visit Betaab Valley and horse riding"
        ],
        "icon": "🏞️"
      },
      {
        "day": "Day 5: Sonamarg Day Trip",
        "activities": [
          "08:00 AM - Depart for Sonamarg",
          "11:00 AM - Explore glaciers and scenic spots",
          "05:00 PM - Return to Srinagar"
        ],
        "icon": "🏔️"
      },
      {
        ...
        "activities": [
          "10:00 AM - Free day for shopping and local exploration",
          "07:00 PM - Cultural dinner"
        ],
        "icon": "🛍️"
      },
      {
    ...
    "gallery": [
      { "img": "https://via.placeholder.com/1200x800?text=Dal+Lake+Houseboat", "caption": "Houseboat on Dal Lake" },
      { "img": "https://via.placeholder.com/1200x800?text=Gulmarg+Skiing", "caption": "Gulmarg Skiing" },
      { "img": "https://via.placeholder.com/1200x800?text=Pahalgam+Betaab+Valley", "caption": "Betaab Valley, Pahalgam" },
      { "img": "https://via.placeholder.com/1200x800?text=Sonamarg+Glaciers", "caption": "Sonamarg Glaciers" },
      { "img": "https://via.placeholder.com/1200x800?text=Shankaracharya+Temple", "caption": "Shankaracharya Temple" },
      { "img": "https://via.placeholder.com/1200x800?text=Kashmir+Markets", "caption": "Srinagar Markets" }
    ],
    "testimonials": [
      {
        "quote": "A breathtaking journey through Kashmir’s natural and cultural treasures.",
        "author": "Imran & Nazia",
        "rating": 5,
        "avatar": "👨‍👩‍👧‍👦"
      }
