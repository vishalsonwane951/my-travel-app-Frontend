 ...
 if ((!packages1 || packages1.length === 0) && (!packages2 || packages2.length === 0)) {
  ...
  return (
    <div className="container my-5">
      ...
      City Tour Packages</h2>

      <div className="row">
        <h1 className="container mb-4" style={{fontFamily:'fantasy'}}>“Uncover Hidden Gems Across <span style={{ color: 'tomato' }}>INDIA</span> with Personalized <br/> <span style={{ color: 'tomato'}}>City</span> Tour Packages...!”</h1>
