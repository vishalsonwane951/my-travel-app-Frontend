  ...
  useEffect(() => {
    const fetchAllPackagesData = async () => {
      ...
      try {
        ...
        const response = await api.get('/explore-packages/andman/getallpackage');
    ...
    <div className="goa-package">
      ...
      <div className="hero-section text-center text-white position-relative">
        ...
        <div className="container position-relative z-index-1 py-5">
          <h1 className="display-3 fw-bold mb-3">Andaman Golden Escape</h1>
          ...
          <div className="pricing-card p-5 rounded-4 shadow-lg">
            <div className="row align-items-center">
              <div className="col-lg-7">
                <h2 className="display-5 fw-bold mb-3">Ready to Experience Andaman?</h2>
      ...
      <div className="container-fluid final-cta py-5 mb-0">
        <div className="container text-center">
          <h2 className="display-5 fw-bold text-white mb-4">Your Andaman Adventure Awaits</h2>
...
[
  {
    ...
    "duration": "3D/2N",
    "highlights": [
      { "icon": "🏝️", "text": "Radhanagar Beach Visit" },
      { "icon": "🤿", "text": "Snorkeling at Elephant Beach" },
      { "icon": "🚤", "text": "Coral Island Excursion" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival & Port Blair Sightseeing",
        "activities": [
          "12:00 PM - Arrival at Port Blair",
          "02:00 PM - Visit Cellular Jail and Light & Sound Show",
          "06:00 PM - Marina Park Walk"
        ],
        "icon": "🏛️"
      },
      {
        "day": "Day 2: Havelock Island Exploration",
        "activities": [
          "07:00 AM - Early Breakfast",
          "08:00 AM - Ferry to Havelock Island",
          "10:00 AM - Relax at Radhanagar Beach",
          "03:00 PM - Snorkeling at Elephant Beach",
          "05:00 PM - Return to Port Blair"
        ],
        "icon": "🏖️"
      },
      {
        "day": "Day 3: Coral Island & Departure",
        "activities": [
          "08:00 AM - Breakfast",
          "09:00 AM - Coral Island boat trip",
    ...
    "gallery": [
      { "img": "https://via.placeholder.com/1200x800?text=Radhanagar+Beach", "caption": "Radhanagar Beach" },
      { "img": "https://via.placeholder.com/1200x800?text=Elephant+Beach+Snorkeling", "caption": "Snorkeling at Elephant Beach" },
      { "img": "https://via.placeholder.com/1200x800?text=Coral+Island", "caption": "Coral Island" },
      { "img": "https://via.placeholder.com/1200x800?text=Cellular+Jail", "caption": "Cellular Jail" },
      { "img": "https://via.placeholder.com/1200x800?text=Port+Blair+Marina", "caption": "Port Blair Marina Park" },
      { "img": "https://via.placeholder.com/1200x800?text=Andaman+Islands", "caption": "Andaman Islands Scenic" }
    ],
    "testimonials": [
      {
        "quote": "Truly a paradise with pristine beaches and amazing water activities!",
        "author": "Neha & Rahul",
        "rating": 5,
        "avatar": "👫"
      }
  ...
  },
  {
    ...
    "duration": "4D/3N",
    "highlights": [
      { "icon": "🏝️", "text": "Radhanagar Beach & Kalapathar" },
      { "icon": "🤿", "text": "Scuba Diving Experience" },
      { "icon": "🐠", "text": "Underwater Marine Life" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival & Port Blair",
        "activities": [
          "12:00 PM - Arrival at Port Blair",
          "02:00 PM - Cellular Jail Visit & Light & Sound Show"
        ],
        "icon": "🏛️"
      },
      {
        "day": "Day 2: Havelock Island & Beaches",
        "activities": [
          "07:00 AM - Ferry to Havelock Island",
          "09:00 AM - Relax at Radhanagar Beach",
          "03:00 PM - Kalapathar Beach Visit"
        ],
        "icon": "🏖️"
      },
      {
        "day": "Day 3: Scuba Diving & Snorkeling",
        "activities": [
          "08:00 AM - Scuba Diving session",
          "12:00 PM - Snorkeling at Elephant Beach",
          "04:00 PM - Return to Port Blair"
        ],
        "icon": "🤿"
      },
      {
        "day": "Day 4: Ross Island & Departure",
        "activities": [
          "09:00 AM - Visit Ross Island",
          "12:00 PM - Checkout and Departure"
        ],
        "icon": "🏝️"
      }
    ...
    "gallery": [
      { "img": "https://via.placeholder.com/1200x800?text=Kalapathar+Beach", "caption": "Kalapathar Beach" },
      { "img": "https://via.placeholder.com/1200x800?text=Scuba+Diving", "caption": "Scuba Diving" },
      { "img": "https://via.placeholder.com/1200x800?text=Elephant+Beach", "caption": "Elephant Beach Snorkeling" },
      { "img": "https://via.placeholder.com/1200x800?text=Ross+Island", "caption": "Ross Island" },
      { "img": "https://via.placeholder.com/1200x800?text=Cellular+Jail", "caption": "Cellular Jail" },
      { "img": "https://via.placeholder.com/1200x800?text=Andaman+Scenery", "caption": "Andaman Islands" }
    ],
    "testimonials": [
      {
        "quote": "Diving into the underwater world was an unforgettable adventure!",
        "author": "Simran & Karan",
        "rating": 5,
        "avatar": "👩‍❤️‍👨"
      }
  ...
  },
  {
    ...
    "duration": "5D/4N",
    "highlights": [
      { "icon": "🏝️", "text": "Havelock & Neil Island Tour" },
      { "icon": "🐢", "text": "Marine Life & Coral Reefs" },
      { "icon": "🚤", "text": "Island Hopping" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival & Port Blair",
        "activities": [
          "12:00 PM - Arrive at Port Blair",
          "02:00 PM - Cellular Jail & Marina Park visit"
        ],
        "icon": "🏛️"
      },
      {
        ...
        "activities": [
          "08:00 AM - Ferry to Havelock Island",
          "10:00 AM - Radhanagar Beach and Kalapathar Beach"
        ],
        "icon": "🏖️"
      },
      {
        "day": "Day 3: Scuba Diving & Snorkeling",
        "activities": [
          "07:00 AM - Scuba Diving experience",
          "12:00 PM - Snorkeling at Elephant Beach"
        ],
        "icon": "🤿"
      },
      {
        "day": "Day 4: Neil Island Exploration",
        "activities": [
          "08:00 AM - Ferry to Neil Island",
          "10:00 AM - Visit Natural Bridge & Bharatpur Beach"
        ],
        "icon": "🏝️"
      },
      {
    ...
    "gallery": [
      { "img": "https://via.placeholder.com/1200x800?text=Neil+Island", "caption": "Neil Island" },
      { "img": "https://via.placeholder.com/1200x800?text=Natural+Bridge", "caption": "Natural Bridge, Neil Island" },
      { "img": "https://via.placeholder.com/1200x800?text=Coral+Reefs", "caption": "Coral Reefs" },
      { "img": "https://via.placeholder.com/1200x800?text=Elephant+Beach", "caption": "Elephant Beach" },
      { "img": "https://via.placeholder.com/1200x800?text=Radhanagar+Beach", "caption": "Radhanagar Beach" },
      { "img": "https://via.placeholder.com/1200x800?text=Port+Blair", "caption": "Port Blair" }
    ],
    "testimonials": [
      {
        "quote": "Island hopping and marine adventures made this trip amazing!",
        "author": "Amit & Sneha",
        "rating": 5,
        "avatar": "👫"
      }
  ...
  },
  {
    ...
    "duration": "7D/6N",
    "highlights": [
      { "icon": "🏝️", "text": "Full Andaman Archipelago Tour" },
      { "icon": "🤿", "text": "Scuba Diving & Snorkeling" },
      { "icon": "🚤", "text": "Island Hopping & Beaches" },
      { "icon": "🐢", "text": "Marine Wildlife Exploration" }
    ],
    "itinerary": [
      {
        "day": "Day 1: Arrival & Port Blair",
        "activities": [
          "12:00 PM - Arrive at Port Blair",
          "03:00 PM - Cellular Jail & Light & Sound Show"
        ],
        "icon": "🏛️"
      },
      {
        ...
        "activities": [
          "07:00 AM - Ferry to Havelock Island",
          "10:00 AM - Radhanagar & Kalapathar Beaches"
        ],
        "icon": "🏖️"
      },
      {
        ...
        "activities": [
          "08:00 AM - Scuba Diving session",
          "01:00 PM - Snorkeling Elephant Beach"
        ],
        "icon": "🤿"
      },
      {
        "day": "Day 4: Neil Island",
        "activities": [
          "08:00 AM - Ferry to Neil Island",
          "11:00 AM - Visit Natural Bridge & Bharatpur Beach"
        ],
        "icon": "🏝️"
      },
      {
        "day": "Day 5: Baratang Island",
        "activities": [
          "07:00 AM - Boat to Baratang Island",
          "10:00 AM - Limestone Caves & Mud Volcano"
        ],
        "icon": "🛶"
      },
      {
        ...
        "activities": [
          "09:00 AM - Free time at Port Blair",
    ...
    "gallery": [
      { "img": "https://via.placeholder.com/1200x800?text=Baratang+Island", "caption": "Baratang Island Limestone Caves" },
      { "img": "https://via.placeholder.com/1200x800?text=Neil+Island+Natural+Bridge", "caption": "Natural Bridge, Neil Island" },
      { "img": "https://via.placeholder.com/1200x800?text=Radhanagar+Beach", "caption": "Radhanagar Beach" },
      { "img": "https://via.placeholder.com/1200x800?text=Scuba+Diving", "caption": "Scuba Diving" },
      { "img": "https://via.placeholder.com/1200x800?text=Port+Blair+Cellular+Jail", "caption": "Cellular Jail" },
      { "img": "https://via.placeholder.com/1200x800?text=Andaman+Islands", "caption": "Andaman Islands" }
    ],
    "testimonials": [
      {
        "quote": "Seven days exploring Andaman was a dream come true!",
        "author": "Kavita & Rohan",
        "rating": 5,
        "avatar": "👨‍👩‍👧‍👦"
      }
